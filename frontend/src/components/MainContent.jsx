    ...
    <div className="container max-w-5xl mx-auto py-12 px-6">
      ...
      <div className="text-center mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          <div className="bg-white border border-gray-200 rounded-xl hover:shadow-lg transition-shadow">
            <div className="pt-12 pb-8 px-6 text-center">
              <div className="w-16 h-16 rounded-full bg-indigo-100 flex items-center justify-center mx-auto mb-6">
                <Building2 className="h-8 w-8 text-indigo-600" />
              </div>
              <h3 className="text-xl font-semibold mb-3">{t("businessOwner")}</h3>
          ...
          <div className="bg-white border border-gray-200 rounded-xl hover:shadow-lg transition-shadow">
            <div className="pt-12 pb-8 px-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">{t("customerSupportTeam")}</h3>
              <p className="text-gray-600 text-sm leading-relaxed">{t("customerSupportTeamContent")}</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-xl hover:shadow-lg transition-shadow">
            <div className="pt-12 pb-8 px-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-3">{t("eCommerceBrands")}</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
