  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        {/* Hiện ReportForm nếu showReportForm === true */}
        {showReportForm && (
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-2">{t("totalUsers")}</p>
              ...
              <div className="flex items-center gap-1 mt-2 text-sm">
                ...
                <span className="text-gray-500">{t("increased") + " " + t("compareTo") + " " + t("yesterday")}</span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-2">{t("totalTicketsFeedback")}</p>
              <p className="text-3xl font-bold text-gray-900">41,187</p>
              <div className="flex items-center gap-1 mt-2 text-sm">
                <TrendingDown className="h-4 w-4 text-red-500" />
                <span className="text-red-500 font-medium">4.3%</span>
                <span className="text-gray-500">{t("decreased") + " " + t("compareTo") + " " + t("yesterday")}</span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-sm text-gray-600 mb-2">{t("totalPending")}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">{t("totalTickets")}</h2>
              ...
              <div className="flex items-center gap-1 mt-1 text-sm">
                ...
                <span className="text-gray-500">{t("compareTo") + " 8/9/2025"}</span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-lg font-semibold text-gray-900">{t("customerSatisfaction")}</h2>
