      ...
      <div className="grid grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            {/* Ticket ID */}
            <div>
              <label className="block text-sm font-semibold text-gray-900 mb-2">Ticket ID cần đánh giá</label>
              <input
                type="text"
        ...
        <div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {/* Feedback Text */}
            <div>
              <label className="block text-sm font-semibold text-gray-900 mb-2">Mô tả trải nghiệm</label>
              <textarea
                placeholder="Trải nghiệm của quý khách ra sao? Hãy chia sẻ để chúng tôi phục vụ tốt hơn! ...."
                value={feedback}
                onChange={(e) => setFeedback(e.target.value)}
                className="w-full border border-gray-300 px-4 py-3 h-24 focus:border-blue-500 focus:outline-none resize-none"
              />
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">File định kèm không vượt quá 200MB</p>
            </div>
