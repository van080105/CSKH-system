    ...
    <div className="p-6 space-y-6">
      <div className="flex gap-3">
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            activeTab === "staff" ? "bg-indigo-600 text-white" : "bg-gray-300 text-gray-700 hover:bg-gray-400"
          }`}
        >
          {t("agent")}
        </button>
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-colors ${
            activeTab === "customer" ? "bg-indigo-600 text-white" : "bg-gray-300 text-gray-700 hover:bg-gray-400"
          }`}
        >
          {t("customer")}
        </button>
      ...
      <div className="bg-white rounded-xl border border-gray-200">
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-y border-gray-200">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">{t("email")}</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">
                  <div className="flex items-center gap-1">
                    {t("status")} <ChevronDown className="h-3 w-3" />
                  </div>
                </th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase">{t("role")}</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {users.map((user, index) => (
                <tr key={index} className={`hover:bg-gray-50 ${index % 2 === 1 ? "bg-gray-50" : "bg-white"}`}>
                  ...
                  <td className="px-4 py-3">
                    <button className="text-sm text-gray-600 hover:text-indigo-600 underline">{t("viewMore")}</button>
                  </td>
                </tr>
              ))}
            </tbody>
        ...
        <div className="px-4 py-3 border-t border-gray-200 flex items-center justify-between">
          <p className="text-sm text-gray-600">{"1-10" + " " + t("of") + " 97"}</p>
